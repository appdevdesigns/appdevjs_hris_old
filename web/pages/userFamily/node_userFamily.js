/**
 * @class hris.client.pages.UserFamily
...
//// UserFamily
////
//// This is the Page level definition for the UserFamily page.
////
...
var userFamilyPage = new AD.App.Interface({
    pathPage: __dirname,
/*
...
module.exports = userFamilyPage;   

////
//// View Routes
////

var app = userFamilyPage.app;

/*
 * You can override the default setup routine by uncommenting this and 
 * making changes:
 * 
userFamilyPage.setup = function(callback) 
{
    var $ = AD.jQuery;
    var dfd = $.Deferred();
    ...
    ////
    var dfdContainers = userFamilyPage.loadContainers();
    
    
    //// 
    //// Scan for any services and load them
    ////
    var dfdPages = userFamilyPage.loadServices();
    
    
    // Scan for any .css files registered for this page
    userFamilyPage.loadPageCSS();
    
    // Create our routes : page/css
    userFamilyPage.createRoutes();
...
/*
 ...
 // if You need to do additional additions to the data being passed to your userFamily.ejs view
...
userFamilyPage.pageStack = [step1];  // make sure this gets called after our page/unitViewer gets loaded:
