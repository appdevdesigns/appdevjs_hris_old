...
/**
 *  
 *  @class hris.client.pages.Objectcreator.RADSetup
 *  @parent hris.client.pages.Objectcreator
 *  
 *  appRAD generated setup script for the Objectcreator Page container. 
 *
 *  The job of this code is to make sure the HTML DOM content required
 *  for the hrisObjectcreatorSetup() is generated before it is called.
 */
...
(function() {
    ...
    var hrisObjectcreatorRADSetup = function() {
        ...
        // place before the hrisObjectcreatorSetup() is called.
        ...
        $.when(initProcess).done(function () {
            ...
            // keep this last:
            // publish a notification it's time to run hrisObjectcreatorSetup()
            AD.Comm.Notification.publish("ad.hris.objectcreator.setup", {});
    ...
    var subscriptionID = AD.Comm.Notification.subscribe('ad.hris.objectcreator.radsetup',hrisObjectcreatorRADSetup);
